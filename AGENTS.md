...
Existing user authorization governs routine edits, tests and repository updates. On 13 September 2026 the owner instructed publication after disclosure that the existing GitHub Pages route makes this reviewed repository and the same 18 sample images public. See the handoff for that audience boundary. Later that day the owner requested nine additional photos from the saved predefined collection for the public sample feed. The reviewed collection now contains 27 photos at 300 x 400; actual posted photos and personal exports remain excluded. This does not authorize another host or further image additions. No paid services, Instagram publishing or cloud sync are authorized by these instructions.
